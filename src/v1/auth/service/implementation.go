...
func NewService(rep repo.Repository) Service {
	return &AuthService{repo: rep}
}

func (s *AuthService) Login(ctx *gin.Context, payload model.LoginAuth) (model.AuthResponse, bool) {
...
func (s *AuthService) Register(ctx *gin.Context, payload model.RegisterAuth) (model.AuthResponse, bool) {
